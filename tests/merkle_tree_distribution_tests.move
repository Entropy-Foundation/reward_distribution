...
module reward_distribution::merkle_tree_distribution_tests {
    ...
    ***********************/
    ...
    #[test(supra = @0x1, owner = @reward_distribution, admin = @supra_framework, alice = @0xA11CE)]
    #[expected_failure(abort_code = 65539)] // E_INVALID_MERKLE_PROOF
    ...
    #[test(supra = @0x1, owner = @reward_distribution, admin = @supra_framework, alice = @0xA11CE)]
    #[expected_failure(abort_code = 196612)] // E_NOTHING_TO_CLAIM
    ...
    #[test(supra = @0x1, owner = @reward_distribution, admin = @supra_framework, alice = @0xA11CE)]
    #[expected_failure(abort_code = 196613)] // E_INSUFFICIENT_VAULT_FUNDS
    ...
    #[test(supra = @0x1, owner = @reward_distribution, admin = @supra_framework, alice = @0xA11CE)]
    #[expected_failure(abort_code = 196612)] // second call hits E_NOTHING_TO_CLAIM
